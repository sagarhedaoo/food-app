  ...
  return (
    ...
    >
      <div className="py-2 flex-1 flex flex-col items-start justify-center md:item-center gap-6">
        <div className="flex items-center gap-2 justify-center bg-orange-100/50 px-4 py-1 rounded-full">
        ...
        <p className="text-[2.5rem] font-bold tracking-wide text-headingColor lg:text-[4rem]">
      ...
      <div className="py-2 flex-1 flex items-center relative">
        <img
          src={HeroBg}
          className="lg:h-650 h-4000 w-full lg:w-auto ml-auto"
          alt="herobg"
        />

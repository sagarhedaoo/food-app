      ...
      >
        ...
        <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
          ...
          <input
            ...
            value={title}
            className="w-full h-full text-lg bg-transparent font-semmibold outline-none 
          ...
          >
            ...
            {categories &&
              categories.map((item) => (
                <option
                  key={item.id}
                  className="text-base border-0 outine-none capitalize bg-white text-headingColor"
